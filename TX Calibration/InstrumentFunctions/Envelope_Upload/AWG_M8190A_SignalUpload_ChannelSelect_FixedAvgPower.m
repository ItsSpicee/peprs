function AWG_M8190A_SignalUpload_ChannelSelect_FixedAvgPower(SignalsCell, CarrierFreqCell, SampleFreqCell, SampleFreqAWG, CorrectionEnabled, DisplaySignal,channel,Expansion_Margin, PAPR_input, PAPR_original)
...
%     channelMapping = [1 0; 0 1] ; %Set I to channel 1 and Q to channel 2 
    if channel == 2
        channelMapping = [0 1; 1 0] ; %Set I to channel 2
    elseif channel == 1
