...
%% User variables
inputFSRdBm = 3.0; %in dBm
freqSpan = 200e6; %correction span
freqInc = 5e6; %correction step size
centerFreq = 300e6;
numavgs = 3;
vsaSpan = freqSpan;%for appropriate 89600 span if different from freqSpan
...
freqStart = centerFreq-freqSpan/2
freqStop = centerFreq+freqSpan/2
...
% Set center frequency and span (for baseband these need to be fixed)
vsaFreq.Center = centerFreq;
