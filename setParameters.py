...
def setMeter(self,buttonFocus,buttonHover,greyHover,boxDone,setButton):
	if setButton.isChecked() == True:
		...
		setButton.setText("Set")
def setSA(self,buttonFocus,buttonPHover,buttonHover,boxDone,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
...
def setP1(self,boxDone,buttonFocus,buttonHover,greyHover,greyButton,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
		...
		setButton.setText("Set")
def setP2(self,boxDone,buttonFocus,buttonHover,greyHoverB,greyButton,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
		...
		setButton.setText("Set")
def setP3(self,boxDone,buttonFocus,buttonHover,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
...
def setVSAMeasDig(self,boxDone,buttonPHover,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
		...
		setButton.setText("Set")
def setVSAMeasGen(self,boxDone,buttonPHover,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
		vsaType = self.ui.vsaWorkflow_vsaMeas.currentIndex()
		vsgType = self.ui.vsgWorkflow_vsaMeas.currentIndex()
...
def rxCalRoutine(self,boxDone,buttonPHover,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
		vsgType = self.ui.vsgWorkflow_vsaMeas.currentIndex()
		if vsgType == 3: # vsg
		...
		setButton.setText("Set")
def noRXCalRoutine(self,boxDone,buttonPHover,setButton):
	if setButton.isChecked() == True:
		setButton.setText("Unset")
		vsgType = self.ui.vsgWorkflow_vsaMeas.currentIndex()
		self.ui.combEquip_vsaMeas.setStyleSheet(boxDone)
...
def setPrevDownButtons(self,buttonHover,greyHover,setButton):
	#meterChecked = self.ui.meterSet.isChecked()
