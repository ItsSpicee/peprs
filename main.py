...
class Window(QMainWindow):
	...
	def initUI(self):		
		...
		# power 2 page
		self.ui.p2Set.clicked.connect(lambda: set.setP2(self))
		# power 3 page
		self.ui.p3Set.clicked.connect(lambda: set.setP3(self))
		...
		self.ui.scopeButton_p3_3.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.scopeButton_p3_4.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		...
		self.ui.digButton_p3_3.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.digButton_p3_4.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.modButton_p3.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.modButton_p3_2.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.uxaButton_p3.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.uxaButton_p3_2.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.pxaButton_p3.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
		self.ui.pxaButton_p3_2.clicked.connect(lambda: flow.changeStack(self,self.ui.equipStack,2))
