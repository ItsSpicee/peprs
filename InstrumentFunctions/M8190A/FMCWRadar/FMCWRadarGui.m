...
if AWGConfig(handles) 
    set(handles.textAWG_Warning,'String','! This demo supports M8195A in single channel mode only');
...
mixer3 = struct('mfg','ADI','model','N9029ACST-U12','GaindB',-10,'Pin1dB',-15,'LoPowerdBm',5 , ...
