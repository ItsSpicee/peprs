...
elseif strcmp(RX.Type, 'UXA')
    [Received_I, Received_Q] = IQCapture_UXA_temp(RX.Fcarrier, ...
            RX.UXA.AnalysisBandwidth, RX.Analyzer.Fsample, RX.Analyzer.NumberOfMeasuredPeriods * RX.Analyzer.FrameTime, RX.VisaAddress, RX.UXA.Attenuation, RX.UXA.ClockReference, RX.UXA.TriggerPort, RX.UXA.TriggerLevel);
